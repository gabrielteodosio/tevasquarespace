...
const csvsUrls = {
  higherRelevance: `${host}metrics/Ativos com maior relevância/1.3.3 Índice Tesouro Pré-Fixado Médio Prazo v0.92.csv`,
  quotes: `${host}quotations/1.3.3 Índice Tesouro Pré-Fixado Médio Prazo v0.92.csv`,
  standardDeviation: `${host}metrics/Desvio padrão/1.3.3 Índice Tesouro Pré-Fixado Médio Prazo v0.92.csv`,
  sharpeIndex: `${host}metrics/Índice Sharpe/1.3.3 Índice Tesouro Pré-Fixado Médio Prazo v0.92.csv`,
  convexity: `${host}metrics/Convexidade/1.3.3 Índice Tesouro Pré-Fixado Médio Prazo v0.92.csv`,
  duration: `${host}metrics/Duration/1.3.3 Índice Tesouro Pré-Fixado Médio Prazo v0.92.csv`,
  modifiedDuration: `${host}metrics/Duration modificada/1.3.3 Índice Tesouro Pré-Fixado Médio Prazo v0.92.csv`,
  yieldToMaturity: `${host}metrics/Yield to maturity/1.3.3 Índice Tesouro Pré-Fixado Médio Prazo v0.92.csv`,
  anualReturn: `${host}metrics/Retorno anual/1.3.3 Índice Tesouro Pré-Fixado Médio Prazo v0.92.csv`,
  turnOverLTM: `${host}metrics/Turnover LTM/1.3.3 Índice Tesouro Pré-Fixado Médio Prazo v0.92.csv`,
  indexExposition: `${host}metrics/Exposição por indexador/1.3.3 Índice Tesouro Pré-Fixado Médio Prazo v0.92.csv`,
  ticksNumber: `${host}metrics/Número de ativos/1.3.3 Índice Tesouro Pré-Fixado Médio Prazo v0.92.csv`,
  repactuationMedia: `${host}metrics/Prazo médio de repactuação/1.3.3 Índice Tesouro Pré-Fixado Médio Prazo v0.92.csv`,
  turnover: `${host}metrics/Turnover/1.3.3 Índice Tesouro Pré-Fixado Médio Prazo v0.92.csv`,
  dueDateExposition: `${host}metrics/Exposição por vencimento/1.3.3 Índice Tesouro Pré-Fixado Médio Prazo v0.92.csv`,
  periodicsReturn: `${host}metrics/Retorno períodos/1.3.3 Índice Tesouro Pré-Fixado Médio Prazo v0.92.csv`,
  monthlyReturn: `${host}metrics/Retorno mensal/1.3.3 Índice Tesouro Pré-Fixado Médio Prazo v0.92.csv`,
};
...
function processQuotes() {
  const processFile = (rows) => {
    ...
    const trace = {
      ...
      name: "Índice Pré-fixado Médio Prazo",
      data: rows.map((row) => {
