...
document.getElementById("esg-filter-text").addEventListener(
  ...
  debounce(
    (e) => {
      ...
      let familyFilter = document.getElementById("esg-family-filter").value.toUpperCase();
...
document.getElementById("esg-family-filter").addEventListener("change", (e) => {
  const filter = e.target.value.toUpperCase();
  const list = document.getElementById("esg-indices-list").children;
  const textFilter = document.getElementById("esg-filter-text").value.toUpperCase();
...
document.getElementById("acoes-filter-text").addEventListener(
  ...
  debounce(
    (e) => {
      ...
      let familyFilter = document.getElementById("acoes-family-filter").value.toUpperCase();
...
document.getElementById("acoes-family-filter").addEventListener("change", (e) => {
  const filter = e.target.value.toUpperCase();
  const list = document.getElementById("acoes-indices-list").children;
  const textFilter = document.getElementById("acoes-filter-text").value.toUpperCase();
