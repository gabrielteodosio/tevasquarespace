...
//4.3.3 Índice de Ações Saúde v0.4
const csvsUrls = {
  ibovespa: `${host}quotations/Ibovespa.csv`,
  higherRelevance: `${host}metrics/Ativos com maior relevância/4.3.3 Índice de Ações Saúde v0.4.csv`,
  quotes: `${host}quotations/4.3.3 Índice de Ações Saúde v0.4.csv`,
  standardDeviation: `${host}metrics/Desvio padrão/4.3.3 Índice de Ações Saúde v0.4.csv`,
  sharpeIndex: `${host}metrics/Índice Sharpe/4.3.3 Índice de Ações Saúde v0.4.csv`,
  anualReturn: `${host}metrics/Retorno anual/4.3.3 Índice de Ações Saúde v0.4.csv`,
  turnOverLTM: `${host}metrics/Turnover LTM/4.3.3 Índice de Ações Saúde v0.4.csv`,
  ticksNumber: `${host}metrics/Número de ativos/4.3.3 Índice de Ações Saúde v0.4.csv`,
  turnover: `${host}metrics/Turnover/4.3.3 Índice de Ações Saúde v0.4.csv`,
  periodicsReturn: `${host}metrics/Retorno períodos/4.3.3 Índice de Ações Saúde v0.4.csv`,
  monthlyReturn: `${host}metrics/Retorno mensal/4.3.3 Índice de Ações Saúde v0.4.csv`,
};
