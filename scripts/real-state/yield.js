...
const csvsUrls = {
  ...
  higherRelevance: `${host}metrics/Ativos com maior relevância/3.5.1 Índice de Fundos Imobiliários Rendimento v0.25.csv`,
  quotes: `${host}quotations/3.5.1 Índice de Fundos Imobiliários Rendimento v0.25.csv`,
  standardDeviation: `${host}metrics/Desvio padrão/3.5.1 Índice de Fundos Imobiliários Rendimento v0.25.csv`,
  sharpeIndex: `${host}metrics/Índice Sharpe/3.5.1 Índice de Fundos Imobiliários Rendimento v0.25.csv`,
  anualReturn: `${host}metrics/Retorno anual/3.5.1 Índice de Fundos Imobiliários Rendimento v0.25.csv`,
  turnOverLTM: `${host}metrics/Turnover LTM/3.5.1 Índice de Fundos Imobiliários Rendimento v0.25.csv`,
  ticksNumber: `${host}metrics/Número de ativos/3.5.1 Índice de Fundos Imobiliários Rendimento v0.25.csv`,
  turnover: `${host}metrics/Turnover/3.5.1 Índice de Fundos Imobiliários Rendimento v0.25.csv`,
  periodicsReturn: `${host}metrics/Retorno períodos/3.5.1 Índice de Fundos Imobiliários Rendimento v0.25.csv`,
  monthlyReturn: `${host}metrics/Retorno mensal/3.5.1 Índice de Fundos Imobiliários Rendimento v0.25.csv`,
};
